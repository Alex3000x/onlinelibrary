        ...
        <div className="mx-auto" style={{ maxWidth: '750px' }}>
          <Form onSubmit={handleSubmit}>
            ...
            <div className="d-flex flex-column flex-sm-row gap-2 bg-transparent bg-sm-white shadow-lg p-1 rounded">
              ...
              <div className="d-flex align-items-center justify-content-start ps-3 pe-0 py-sm-0 bg-white rounded border-sm-end" style={{ minWidth: '185px' }}>
                <span className="text-dark me-2" style={{ fontWeight: '700', whiteSpace: 'nowrap', fontSize: '1rem' }}>Cerca per:</span>
                <Form.Select 
                  value={criteria}
              ...
              <InputGroup className="bg-white rounded overflow-hidden flex-grow-1">
                ...
                <Button 
                  ...
                  style={{ backgroundColor: '#E190B6', borderColor: '#E190B6', width: '55px' }}
