...
import { Row, Col, Container, Badge, Form, Spinner, Button } from "react-bootstrap";
    ...
    async function fetchBooks() {
      try {
        ...
        const response = await axios.get(
          "http://localhost:3000/topinibrary/books?" +
            searchCriteria +
            "=" +
            searchTerm,
        );
      ...
      >
        ...
        {totalPages > 1 && (
          <div className="d-flex justify-content-center align-items-center gap-3 mt-5 mb-5">
            ...
            <div
              className="fw-bold"
              style={{ color: paginationColors.text, fontSize: "1.1rem" }}
            >
              Pagina{" "}
              <span
                style={{
                  color: paginationColors.activeNumber,
                  fontSize: "1.3rem",
                }}
              >
                {currentPage}
