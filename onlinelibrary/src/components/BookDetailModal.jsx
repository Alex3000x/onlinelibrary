...
function BookDetailModal({ show, onHide, book }) {
  ...
  const numericCopies =
    book.copiesNumber !== undefined &&
    book.copiesNumber !== null &&
    book.copiesNumber !== ""
        ...
        <Row>
          ...
          <Col md={5} className="text-center mb-3 mb-md-0">
            <img
              ...
              src={
                book.ISBN && book.ISBN !== "N/A" && book.ISBN.trim() !== ""
          ...
          <Col md={7}>
            <div className="d-flex justify-content-between align-items-start mb-2">
              ...
              <Badge
                pill
                bg={book.available !== false ? "success" : "danger"}
                className="p-2 px-3"
              >
            ...
            <div className="mt-4 border-top pt-3">
              <Row className="text-muted">
                <Col xs={6}>
                  ...
                  {renderText(book.publicationYear)}
                </Col>
                <Col xs={6}>
                  <strong>ISBN:</strong> {renderText(book.ISBN) || "N/A"}
                </Col>
              </Row>
              ...
              <Row className="text-muted mt-2">
                <Col xs={6}>
                  ...
                  <span
                    className={`ms-2 ${numericCopies > 0 ? "text-dark" : "text-danger"}`}
                  >
              ...
              <div className="mt-3">
                <Badge bg="info" className="me-2 p-2">
                  {renderText(book.genre)}
                </Badge>
                <Badge bg="secondary" className="p-2">
                  {renderText(book.publisher)}
                </Badge>
              </div>
            </div>
          </Col>
